...
namespace AdventOfCode
{
	public static class Color
	{
		...
		public const string Black = "\x1B[90m";
		public const string DarkBlack = "\x1B[30m";
		public const string BgBlack = "\x1B[100m";
		public const string BgDarkBlack = "\x1B[40m";
		...
		public const string BgDarkWhite = "\x1B[47m";
	}
}